<template>
    <div class="bg-transparent px-8 pt-14 pb-12">
        <h1 class="text-4xl font-bold text-center text-ink-primary mb-4">
            发现并收藏最好的开发者资源
        </h1>
        <p class="text-md text-center text-ink-secondary mb-8">
